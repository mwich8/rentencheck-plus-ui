 ...
 */
export const WERBUNGSKOSTENPAUSCHALE = 102;

/**
 * Sonderausgabenpauschale (§10c EStG).
 * A flat €36 deduction applied to all taxpayers.
 */
export const SONDERAUSGABENPAUSCHALE = 36;
