...
import { InputPanelComponent } from './features/calculator/input-panel/input-panel.component';
import { ResultPanelComponent } from './features/calculator/result-panel/result-panel.component';
...
import { PricingTierComponent } from './features/calculator/pricing-tier/pricing-tier.component';
...
/**
 * Root AppComponent for RentenCheck+.
 *
 * Wires together:
 * - InputPanel (left column, user signals)
 * - ResultPanel + Charts (right column, computed from input signals)
 * - PricingTier (bottom, monetization)
 *
 * All calculations run client-side via Signals for zero-latency slider updates.
 */
@Component({
  selector: 'app-root',
  standalone: true,
...
export class AppComponent {
   ...
   * This is the core signal chain: Input signals → PensionInput → PensionResult
   */
